...
export default (router: Router): void => {
    router.post('/product', adaptMiddleware(makeAuthenticationMiddleware()), adaptRouter(makeCreateProductController()))
    router.put('/product', adaptMiddleware(makeAuthenticationMiddleware()), adaptRouter(makeUpdateProductController()))
